...
assert.ok(index.includes('/assets/vendor/supabase-2.49.8.umd.js'));
assert.ok(index.indexOf('/assets/vendor/supabase-2.49.8.umd.js') < index.indexOf('<script src="assets/phase2-experience.js'));
