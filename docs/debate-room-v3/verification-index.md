...
- **Deployment/launch:**restricted staging deployed exact f0c4d6b/version 1be1d9c5-af54-4f89-b48c-d941968849ab; preservation and 18 anonymous asset hashes passed. The authenticated smoke remains failed before authorization. Authenticated navigation/deep-link/cache behavior, full hosted flow, actual deployed rollback and public launch approval remain open.

Historical pre-application inventory, local adapted installation rollback, failed browser/OOM/cron/attendance runs and reviewed synthetic samples remain traceable. Actual database migrations are now applied; the separate restricted Worker deployment has passed preservation but failed authenticated smoke. No provider connection, real mail, recording, production change, upgrade or new spending is claimed. The superior outage/pricing task's recovery assets, DNS and backups remain protected.
