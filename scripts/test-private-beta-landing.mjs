...
assert.match(html, /assets\/private-beta-landing\.js\?v=exam-room-ux-20260814-2&amp;release=homepage-feature-ledger-20260815-1/,
  'The homepage and chamber redesign must use a fresh browser cache key.');
