...
assert.match(publicPage, /assets\/phase2-experience\.js\?v=profile-photo-release2-20260827-1/);
assert.match(publicPage, /assets\/phase4-experience\.js\?v=syllabus-reveal-p0-20260826-2/);
