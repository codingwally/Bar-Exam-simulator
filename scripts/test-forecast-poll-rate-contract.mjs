...
test('online shell, lazy loader and cache-first service worker use matching new polling asset URLs', async () => {
  ...
  assert.match(serviceWorker, /const CACHE_VERSION = 'duediligence-shell-astra-analytics-count-copy-20260908-r1-asset-recovery-20260909-r1-home-readable-20260910-1';/);
});
