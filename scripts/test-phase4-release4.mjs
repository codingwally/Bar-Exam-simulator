...
assert.match(publicPage, /assets\/phase2-experience\.js\?v=single-signin-entry-20260822-1/);
assert.match(publicPage, /assets\/phase4-experience\.js\?v=access-badge-20260822-1/);
