...
assert.match(html, /assets\/phase2\.css\?release=profile-photo-release2-20260827-1/);
...
assert.match(serviceWorker, /duediligence-shell-astra-simulator-presentation-20260908-r1/);
