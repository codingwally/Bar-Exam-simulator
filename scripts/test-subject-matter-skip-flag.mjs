...
assert.match(featureLoader, /assets\/examinations\.css\?v=syllabus-reveal-p0-20260826-2/);
assert.match(featureLoader, /assets\/examinations\.js\?v=syllabus-reveal-p0-20260826-2/);
