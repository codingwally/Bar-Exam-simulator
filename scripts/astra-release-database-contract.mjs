...
export const ASTRA_MIGRATIONS = Object.freeze([
  ...
  '20260907091138_astra_forecast_analytics_scope_exports.sql',
  ...
  '20260907130001_astra_simulator_verified_source_presentation.sql',
]);
...
if (mode === '--print-attestation') console.log(attestation);
  ...
  assert.equal(new Set(ASTRA_MIGRATIONS).size, 9);
