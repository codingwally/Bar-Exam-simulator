...
const migrationName = '20260907223228_astra_simulator_verified_source_presentation.sql';
...
test('future-only presentation and family allocation under actual PostgreSQL', {
  ...
  try {
    ...
    // Fresh CLI-generated forward source follows the installed access-policy dependency.
