...
Updated 2026-09-09. **Hosted run 34369187490 deployed exact e9e6608, then failed after 27.747 seconds: event creation succeeded, but reload produced an unclassified events 403 and zero timed stages. All eleven fixtures and the event were cleaned and independently verified absent. No complete hosted rehearsal or production release is claimed.**
...
[Historical candidate 85193a75](evidence/ci-validation-85193a75.json) passed the 13 suite groups and both synthetic browsers but its overall run failed on native harness error 42725, as preserved in [the native failure receipt](evidence/native-cleanup-ci-85193a75.json). [Its browser receipt](evidence/browser-ci-85193a75.json) remains the latest actual screenshot-review anchor: exactly two 1365px / 320px views with bundled fonts, controls above the arena and exposed headings. Later green CI does not create a new visual-review claim. Historical 147bb582 visual and CI evidence also remains preserved.
...
PR 356 merged the implementation to main 30a90e85b56b72c8da53b857e70b2db428809eb3; PR 357 merged the narrow fixture-client correction to f0c4d6be4203d0a3688521694145d86a0462f2a4; PR 358 merged the later gates and browser assertions to 1a0a30f00ab3ca441c9ba73df3605f11ecbc9b9f after the green final candidate above. The earlier f0c4d6b restricted staging deployment is preserved below as historical evidence; the current e9e6608 deployment is recorded above. Neither repository merge nor staging release establishes production deployment or public launch.
