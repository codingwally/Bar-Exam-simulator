...
assert.match(html, /phase2-experience\.js\?v=profile-photo-release2-20260827-1&amp;baseline=syllabus-reveal-p0-20260826-2-examination-room-4/);
...
assert.doesNotMatch(experience, /privacy warning appears before the exam begins/i);
assert.match(experience, /Questions stay sealed until the examination opens/i);
...
assert.match(serviceWorker, /phase2-experience\.js\?v=profile-photo-release2-20260827-1&baseline=syllabus-reveal-p0-20260826-2-examination-room-4/);
