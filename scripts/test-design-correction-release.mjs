...
assert.match(html, /assets\/phase2\.css\?release=policy-media-gate-20260821-1/);
...
assert.match(serviceWorker, /duediligence-shell-20260821-policy-media-gate-1/);
assert.match(serviceWorker, /quorum-first-shell\.css\?v=home-menu-cleanup-20260821-1/);
assert.match(serviceWorker, /quorum-first-shell\.js\?v=home-menu-cleanup-20260821-1/);
assert.match(serviceWorker, /phase2\.css\?release=policy-media-gate-20260821-1/);
