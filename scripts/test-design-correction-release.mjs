...
assert.match(serviceWorker, /duediligence-shell-20260822-home-routing-menu-icons-1/);
assert.match(serviceWorker, /quorum-first-shell\.css\?v=home-routing-menu-icons-20260822-1/);
